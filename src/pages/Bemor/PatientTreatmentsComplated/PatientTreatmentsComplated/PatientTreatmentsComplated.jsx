...
import s from "./PatientTreatmentsComplated.module.scss"
...
const PatientTreatmentsComplated = () => {
    ...
    useEffect(() => {
        const fetchPlans = async () => {
            try {
                ...
                const res = await fetch(`${api}/patient/me/treatments/completed/list/`, {
                    method: 'GET',
                    headers: {
    ...
    return (
        <div className={s.PatientsPage}>
            ...
            <div className={s.TopRow}>
                <div>
                    <h1>Yakunlangan davolanish rejalari</h1>
...
export default PatientTreatmentsComplated